...
interface MultipleSelectCheckMarksStandardProps<TFieldValues extends FieldValues>
...
const MultipleSelectCheckMarksStandard = <TFieldValues extends FieldValues>({
  label,
  name,
  control,
  defaultValue,
  ...
  options,
  ...rest
}: MultipleSelectCheckMarksStandardProps<TFieldValues>) => {
  return (
    <>
      {label && (
...
export default MultipleSelectCheckMarksStandard;
